 ...
 */
gifski *gifski_new(JNIEnv *env, const GifskiSettings *settings);
 ...
 */
GifskiError gifski_add_frame_png_file(JNIEnv *env, gifski *handle,
 ...
 * Returns 0 (`GIFSKI_OK`) on success, and non-0 `GIFSKI_*` constant on error.
 */
GifskiError gifski_add_frame_rgba(JNIEnv *env, gifski *handle,
                                  uint32_t frame_number,
                                  uint32_t width,
                                  uint32_t height,
 ...
 * Returns 0 (`GIFSKI_OK`) on success, and non-0 `GIFSKI_*` constant on error.
 */
GifskiError gifski_set_file_output(JNIEnv *env, gifski *handle, const char *destination_path);
